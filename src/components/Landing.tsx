        ...
        <div className="landing-container">
          ...
          <div className="landing-info">
            ...
            <div className="landing-ctas">
              ...
              <a href={import.meta.env.BASE_URL + "Harsh_Makhija_CV.pdf"} target="_blank" rel="noopener noreferrer" download="Harsh_Makhija_CV.pdf" className="btn btn-secondary">Download Resume</a>
            </div>
          </div>
        </div>
        {children}
