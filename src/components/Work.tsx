...
const projects: Project[] = [
  ...
  {
    title: "Wandr",
    category: "DDT project · Product design concept",
    tools: "Group quiz matching · hidden-place discovery · community safety scoring",
    outcome:
      "Designed a group-travel concept that turns competing preferences into a shared shortlist of verified places, stays, and local experiences.",
    image: import.meta.env.BASE_URL + "images/product-ddt-wandr.svg",
    link: "https://harshmakhija24.github.io/DDT-PROJECT-/",
    linkLabel: "Experience Wandr",
    previewLink: "https://harshmakhija24.github.io/DDT-PROJECT-/",
    previewLabel: "Preview Wandr concept",
    kind: "venture",
    themeClass: "accent-tech",
  },
  {
